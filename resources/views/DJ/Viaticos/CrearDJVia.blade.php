...
@section('contenido')
  ...
  <form method = "POST" action = "{{ route('DJViaticos.Empleado.Guardar') }}" onsubmit="" id="frmDJVar" name="frmDJVar">
          ...
          <div class="container"> {{-- OTRO CONTENEDOR DENTRO DE LA CELDA --}}
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control" value="{{ App\DJGastosViaticos::calcularCodigoCedepasLibre() }}" readonly>
              </div>
            </div>
...
@section('script')
  ...
  <script>
    ...
    function validarFormCrear() { //Retorna TRUE si es que todo esta OK y se puede hacer el submit
      ...
      msj = validarTamañoMaximoYNulidad(msj, 'domicilio', {{ App\Utils\Configuracion::tamañoMaximoDomicilio }}, 'Domicilio');
    ...
    function agregarDetalle() {
      ...
      msjError = validarTamañoMaximoYNulidad(msjError, 'nuevoLugar', {{ App\Utils\Configuracion::tamañoMaximoLugar }}, 'Lugar');
          ...
          `
                <tr class="selected" id="fila` + item + `" name="fila` + item + `">
                            ...
                            <td style="text-align:center;">
                                <input type="text" class="form-control" name="colFecha` + item + `" id="colFecha` + item + `" value="` +
          element.fecha + `" readonly style="font-size:10pt; text-align:center"  >
                            </td>

                            <td style="text-align:center;">
                                <input type="text" class="form-control" name="colLugar` + item + `" id="colLugar` + item + `" value="` +
          element.lugar + `" readonly>
                            </td>



                            <td  style="text-align:right;">
                                <input style="text-align:right;" type="text" class="form-control" value="` + parseFloat(element
            .montoDesayuno).toFixed(2) + `" readonly>
                                <input type="hidden" class="form-control" name="colMontoDesayuno` + item + `" id="colMontoDesayuno` +
          item + `" value="` + (element.montoDesayuno) + `" readonly>
                            </td>

                            <td  style="text-align:right;">
                                <input style="text-align:right;" type="text" class="form-control" value="` + parseFloat(element
            .montoAlmuerzo).toFixed(2) + `" readonly>
                                <input type="hidden" class="form-control" name="colMontoAlmuerzo` + item + `" id="colMontoAlmuerzo` +
          item + `" value="` + (element.montoAlmuerzo) + `" readonly>
                            </td>

                            <td  style="text-align:right;">
                                <input style="text-align:right;" type="text" class="form-control" value="` + parseFloat(element.montoCena)
          .toFixed(2) + `" readonly>
                                <input type="hidden" class="form-control" name="colMontoCena` + item + `" id="colMontoCena` + item +
          `" value="` + (element.montoCena) + `" readonly>
                            </td>

                            <td  style="text-align:right;">
                                <input style="text-align:right;" type="text" class="form-control" value="` + parseFloat(element.montoDia)
          .toFixed(2) + `" readonly>
                                <input type="hidden" class="form-control" name="colImporte` + item + `" id="colImporte` + item +
          `" value="` + (element.montoDia) + `" readonly>
                            </td>
