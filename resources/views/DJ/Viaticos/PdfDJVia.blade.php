...
<head>
  <title>Declaración Jurada {{ $DJ->codigoCedepas }}- Gastos Viáticos</title>
      ...
      <thead style="width:100%">
        <tr>
          <th style="height: 70px; float: left" colspan="2">
            <img src="{{ App\Utils\Configuracion::getRutaImagenCedepasPNG() }}" height="100%" style="float: left">
          </th>
        ...
        <tr>
          <th colspan="4" style="text-align: center; background-color: rgb(0, 102, 205); color: white">
            DECLARACIÓN JURADA - GASTOS VIÁTICOS
          </th>
        </tr>
      </thead>
      <tbody>
      ...
      <tbody style="width:100%;">
        ...
        <tr>
          <td colspan="6">
            ...
            domiciliado/a en
            <b> {{ $DJ->domicilio }} </b> DECLARO BAJO JURAMENTO haber realizado gastos de los cuales no tengo documentos sustentatorios
        ...
        <tr style="font-weight: bold; background-color:rgb(238, 238, 238);">
          <td rowspan="2" style="width: 80px; text-align: center;">Fecha</td>
          <td rowspan="2" style="text-align: center;">Lugar</td>
          <td colspan="3" rowspan="1" style="text-align: center;">Concepto</td>
          <td rowspan="2" style="width: 90px; text-align: center;">Importe Día</td>
        </tr>
        <tr style="font-weight: bold; background-color:rgb(238, 238, 238);">
          <td style="width: 90px; text-align: center;">Desayuno {{ $DJ->getMoneda()->simbolo }}</td>
          <td style="width: 90px; text-align: center;">Almuerzo {{ $DJ->getMoneda()->simbolo }}</td>
          <td style="width: 90px; text-align: center;">Cena {{ $DJ->getMoneda()->simbolo }}</td>
        </tr>
        ...
        <tr>
          ...
          <td class="sinlineas"></td>
          <td colspan="3" style="font-weight: bold; background-color:rgb(238, 238, 238); text-align: center">Total
            {{ $DJ->getMoneda()->simbolo }}</td>
          <td style="text-align: right; background-color:rgb(238, 238, 238);">{{ $DJ->getMontoConMoneda() }}</td>
        </tr>
