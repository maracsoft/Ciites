...
@section('contenido')
  ...
  <form method = "POST" action = "{{ route('DJVarios.Empleado.Guardar') }}" onsubmit="" id="frmDJVar" name="frmDJVar">
          ...
          <div class="container"> {{-- OTRO CONTENEDOR DENTRO DE LA CELDA --}}
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control" value="{{ App\DJGastosVarios::calcularCodigoCedepasLibre() }}" readonly>
              </div>
            </div>
...
@section('script')
  ...
  <script>
    ...
    function agregarDetalle() {
      ...
      msjError = validarTamañoMaximoYNulidad(msjError, 'nuevoConcepto', {{ App\Utils\Configuracion::tamañoMaximoConceptoDJ }}, 'Concepto');
      ...
      for (let item = 0; item < detalleVar.length; item++) {
        ...
        var fila = `
          ...
          element.fecha + `" readonly style="font-size:10pt; text-align:center"  >
                            ...
                            <td style="text-align:center;">
                                <input type="text" class="form-control" name="colConcepto` + item + `" id="colConcepto` + item +
          `" value="` + element.concepto + `" readonly>
                            </td>
