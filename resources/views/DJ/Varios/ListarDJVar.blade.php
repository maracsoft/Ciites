...
<div style="text-align: center">
  ...
  <br>
    ...
    <div class="row">
      <div class="col-md-2">
        <a href="{{route('DJVarios.Empleado.Crear')}}" class = "btn btn-primary" style="margin-bottom: 5px;"> 
    ...
    <table class="table" style="font-size: 10pt;">
          <thead class="thead-dark">
            <tr>
              ...
              <th width="12%" style="text-align: center">Importe.</th>
    ...
    <tbody>
      ...
      @foreach($listaDJ as $itemDJ)
          <tr>
              ...
              <td>
                <a href="{{route('DJVarios.Empleado.ver',$itemDJ->codDJGastosVarios)}}" class='btn btn-info btn-sm' title="Descargar DJ">
                  <i class="fas fa-eye"></i>
                </a>
                
                <a href="{{route('DJVarios.Empleado.descargarPDF',$itemDJ->codDJGastosVarios)}}" class='btn btn-info btn-sm' title="Descargar PDF">
                  <i class="fas fa-file-download"></i>
                </a>
                <a target="pdf_djvar{{$itemDJ->codDJGastosVarios}}" href="{{route('DJVarios.Empleado.verPDF',$itemDJ->codDJGastosVarios)}}" class='btn btn-info btn-sm'  title="Ver PDF">
