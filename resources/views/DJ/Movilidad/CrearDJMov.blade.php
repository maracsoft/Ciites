...
@section('contenido')
  ...
  <form method = "POST" action = "{{ route('DJMovilidad.Empleado.Guardar') }}" onsubmit="" id="frmDJMov" name="frmDJMov">
          ...
          <div class="container"> {{-- OTRO CONTENEDOR DENTRO DE LA CELDA --}}
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                <input type="text" class="form-control" value="{{ App\DJGastosMovilidad::calcularCodigoCedepasLibre() }}" readonly>
              </div>
...
@section('script')
  ...
  <script>
    ...
    function agregarDetalle() {
      ...
      msjError = validarTamañoMaximoYNulidad(msjError, 'nuevoDetalle', {{ App\Utils\Configuracion::tamañoMaximoDetaleDJ }}, 'Detalle');
      ...
      for (let item = 0; item < detalleMov.length; item++) {
        ...
        var fila = `
          ...
          element.lugar + `" readonly>
                            ...
                            <td style="text-align:center;">
                                <input type="text" class="form-control" name="colDetalle` + item + `" id="colDetalle` + item +
          `" value="` + element.detalle + `" readonly>
                            </td>



                            <td  style="text-align:right;">
                                <input style="text-align:right;" type="text" class="form-control" value="` + number_format(element.importe,
            2) + `" readonly>
                                <input type="hidden" class="form-control" name="colImporte` + item + `" id="colImporte` + item +
          `" value="` + (element.importe) + `" readonly>
                            </td>
