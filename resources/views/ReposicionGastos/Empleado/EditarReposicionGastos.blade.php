              ...
              <div class="col"> {{-- input de proyecto --}}
                <select class="form-control" id="codProyecto" name="codProyecto" onchange="actualizarCodPresupProyecto()">
                  ...
                  @foreach ($proyectos as $itemproyecto)
                    <option value="{{ $itemproyecto->codProyecto }}" @if ($itemproyecto->codProyecto == $reposicion->codProyecto) selected @endif>
              ...
              <div class="col">
                <select class="form-control" id="codMoneda" name="codMoneda">
                  ...
                  @foreach ($monedas as $itemmoneda)
                    <option value="{{ $itemmoneda->codMoneda }}" @if ($itemmoneda->codMoneda == $reposicion->codMoneda) selected @endif>
                      {{ $itemmoneda->nombre }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="col">
                <select class="form-control" id="codBanco" name="codBanco">
                  ...
                  @foreach ($bancos as $itembanco)
                    <option value="{{ $itembanco->codBanco }}" @if ($itembanco->codBanco == $reposicion->codBanco) selected @endif>
        ...
        <div class="col-md"> {{-- COLUMNA DERECHA --}}
          <div class="container">
            <div style="margin-bottom: 1%">
              ...
              <textarea class="form-control" name="resumen" id="resumen" aria-label="With textarea" cols="3">{{ $reposicion->resumen }}</textarea>
            ...
            <div class="container row"> {{-- OTRO CONTENEDOR DENTRO DE LA CELDA --}}
              ...
              <div class="col">
                <input type="text" class="form-control" name="numeroCuentaBanco" id="numeroCuentaBanco"
                  value="{{ $reposicion->numeroCuentaBanco }}">
              </div>
              <div class="w-100"></div> {{-- SALTO LINEA --}}
              <div class="colLabel">
              ...
              <div class="col">
                <input type="text" class="form-control" name="codigoContrapartida" id="codigoContrapartida"
                  value="{{ $reposicion->codigoContrapartida }}">
              </div>
  ...
  <script type="application/javascript">
    ...
    //se ejecuta cada vez que escogewmos un file
        ...
        function validarFormularioEdit(){ //Retorna '' si es que todo esta OK y 'msje error aqui' si no
            ...
            msj = validarTamañoMaximoYNulidad(msj,'numeroCuentaBanco',{{App\Utils\Configuracion::tamañoMaximoNroCuentaBanco}},'Numero de Cuenta Bancaria');
            msj = validarTamañoMaximoYNulidad(msj,'girarAOrdenDe',{{App\Utils\Configuracion::tamañoMaximoGiraraAOrdenDe}},'Girar a Orden de...');
