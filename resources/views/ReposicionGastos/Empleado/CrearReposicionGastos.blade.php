...
@section('contenido')
  ...
  <form method = "POST" action = "{{ route('ReposicionGastos.Empleado.store') }}" id="frmrepo" name="frmrepo" enctype="multipart/form-data">
    ...
    <input type="hidden" name="fechaHoraRenderizadoVistaCrear" id="fechaHoraRenderizadoVistaCrear"
      value="{{ $fechaHoraRenderizadoVistaCrear }}">
    {{-- CODIGO DEL EMPLEADO --}}
            ...
            <div class="row">
              ...
              <div class="col">
                <input type="text" readonly class="form-control"
                  value="{{ App\ReposicionGastos::calcularCodigoCedepas($objNumeracion) }}
                            ">
              </div>
      ...
      <div id="guardar">
        <div class="form-group">
          ...
          <button type="button" class="btn btn-primary " id="btnRegistrar"
            data-loading-text="<i class='fa a-spinner fa-spin'></i> Registrando" onclick="registrar()"><i class='fas fa-save'></i>
            Registrar</button>

          <a href="{{ route('ReposicionGastos.Empleado.Listar') }}" class='btn btn-info float-left'><i class="fas fa-arrow-left"></i>
            Regresar al Menú</a>
        </div>
      </div>
    </div>
