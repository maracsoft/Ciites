      ...
      <table class="table table-hover" style="font-size: 10pt; margin-top:10px; ">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th width="6%" scope="col" style = "text-align: center">F. Contabilización</th>
        ...
        <tbody>
          ...
          @foreach($listaReposiciones as $itemreposicion)
              ...
              <tr>
                  ...
                  <td style="text-align: center; padding: 0.40rem">{{$itemreposicion->formatoFechaHoraRevisionConta()}}</td>
                  <td style = "padding: 0.40rem">
                    @if($itemreposicion->verificarEstado('Abonada'))
                      <a href="{{route('ReposicionGastos.Contador.ver',$itemreposicion->codReposicionGastos)}}" class="btn btn-warning btn-sm" title="Contabilizar Reposición">
                        <i class="fas fa-hand-holding-usd"></i>
                      </a>
                    @else
                      <a href="{{route('ReposicionGastos.Contador.ver',$itemreposicion->codReposicionGastos)}}" class="btn btn-info btn-sm" title="Ver Reposición">
