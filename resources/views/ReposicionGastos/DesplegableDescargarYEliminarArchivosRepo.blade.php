  ...
  <div class="panel panel-default">
      ...
      <div id="collapseArchivos" class="panel-collapse collapse card-body p-0">
        <table class="table table-striped table-bordered table-condensed table-hover" 
          ...
          <tbody>
            @foreach ($reposicion->getListaArchivos() as $itemArchivo)
            <tr>
                <td style = "padding: 0.50rem">
                    <a href="{{route('ReposicionGastos.descargarCDP',$itemArchivo->codArchivoRepo)}}">
                ...
                <td>
                    <a href="#" onclick="clickEliminarArchivo({{$itemArchivo->codArchivoRepo}},'{{$itemArchivo->nombreAparente}}')">
...
<script>
    ...
    function clickEliminarArchivo(codArchivoRepo,nombre){
      codArchivoAEliminar = codArchivoRepo;
    ...
    function ejecutarEliminacionArchivo(){
      location.href = "/ReposicionGastos/eliminarArchivo/" + codArchivoAEliminar;
