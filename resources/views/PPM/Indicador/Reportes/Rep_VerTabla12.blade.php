@php
  ...
  if($descargarExcel){
    ...
    header("Content-Disposition: attachment; filename=Reporte de Indicador 1.2 .xls");
...
<table border="1" style="{{$subtitulo}}">
  <tbody>
    <tr>
      <td style="{{$textCenter}}" colspan="12">  
        Indicador 2: Al finalizar el proyecto el 80% mujeres capacitadas, lideran organizaciones de sociedad civil.
      </td>
    </tr>
  </tbody>
</table>
...
<table border="1" style="">
  <thead style="{{$fondoPlomo}}" >
      <tr  style="{{$fondo_celeste}}">
        ...
        <th  colspan="3" class="text-center">Sexo</th>
        ...
        <th  rowspan="2">Temas de capacitacion</th>
      </tr>
      <tr  style="{{$fondo_celeste}}">
        <th >
          H
  ...
  <tbody>
    ...
    @forelse($listaRelaciones as $relacion)
      ...
      <tr>
        ...
        <td>
          {{$relacion->ind12_temas_capacitacion}}
        </td>
