      ...
      <div class="card-tools">
        <ul class="nav nav-pills ml-auto">
          <li class="nav-item">
            ...
            <button href="#" class="btn btn-success" onclick="limpiarModal()" data-toggle="modal" data-target="#ModalObjetivoMilenio">
          ...
          @foreach ($objetivosMilenio as $obj)
            <tr>
              ...
              <td>
                ...
                <button type="button" class="btn btn-info" onclick="clickEditarObjetivo({{ $obj->codObjetivoMilenio }})" data-toggle="modal"
                  data-target="#ModalObjetivoMilenio">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="frmObjMilenio" name="frmObjMilenio" action="{{ route('ObjetivoMilenio.agregarEditarObjetivo') }}" method="POST">
            <input type="{{ App\Utils\Configuracion::getInputTextOHidden() }}" name="codObjetivoMilenio" id="codObjetivoMilenio"
              value="0">
            @csrf
...
@section('script')
  ...
  <script>
    ...
    function confirmarGenerarRelaciones() {
      confirmarConMensaje("Confirmación", "¿Desea generar todas las relaciones faltantes entre proyectos y obj del Milenio?", 'warning',
        ejecutarGenerarRelaciones);
    }
