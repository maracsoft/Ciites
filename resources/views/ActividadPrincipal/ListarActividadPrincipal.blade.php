      ...
      <div class="card-tools">
        <ul class="nav nav-pills ml-auto">
          <li class="nav-item">
            ...
            <button href="#" class="btn btn-success" onclick="limpiarModal()" data-toggle="modal" data-target="#ModalActividadPrincipal">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="frmActividadPrincipal" name="frmActividadPrincipal" action="{{ route('ActividadPrincipal.guardarEditarActividad') }}"
            method="POST">
            <input type="{{ App\Utils\Configuracion::getInputTextOHidden() }}" name="codActividadPrincipal" id="codActividadPrincipal"
              value="0">
            @csrf
...
<script>
  ...
  function validarFormularioActividad() {
    ...
    msjError = "";
    msjError = validarTamañoMaximoYNulidad(msjError, 'descripcion', {{ App\Utils\Configuracion::tamañoMaximoDescripcionAP }},
    'Descripción');
