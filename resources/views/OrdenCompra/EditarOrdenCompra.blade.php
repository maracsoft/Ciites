      ...
      <div class="col-md"> {{-- COLUMNA IZQUIERDA 1 --}}
        <div class="container"> {{-- OTRO CONTENEDOR DENTRO DE LA CELDA --}}
          ...
          <div class="row">
            ...
            <div class="col">
              <input type="text" class="form-control" name="partidaPresupuestal" id="partidaPresupuestal"
                value="{{ $orden->partidaPresupuestal }}">
            </div>
            <div class="w-100"></div> {{-- SALTO LINEA --}}
            <div class="colLabel">
            ...
            <div class="col">
              <textarea class="form-control" name="observacion" id="observacion" aria-label="With textarea" rows="3">{{ $orden->observacion }}</textarea>
      ...
      <div class="table-responsive">
        <table id="detalles" class="table table-striped table-bordered table-condensed table-hover" style='background-color:#FFFFFF;'>
          <thead>
            ...
            <th class="text-center">
              <input type="checkbox" name="exoneradoIGV" id="exoneradoIGV" onchange="cambioEstadoIGV()" class="CBgrande">
            </th>
            <th class="text-center">
              <div>
