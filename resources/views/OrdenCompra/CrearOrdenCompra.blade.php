      ...
      <div class="col-md"> {{-- COLUMNA IZQUIERDA 1 --}}
        <div class="container"> {{-- OTRO CONTENEDOR DENTRO DE LA CELDA --}}
          ...
          <div class="row">
            ...
            <div class="col">
              <input type="text" readonly class="form-control" value="{{ App\OrdenCompra::calcularCodigoCedepasLibre($objNumeracion) }}">
            </div>
            ...
            <div class="col">
              <textarea class="form-control" name="observacion" id="observacion" aria-label="With textarea" rows="2"></textarea>
            </div>
          ...
          <div class="row">
            ...
            <div class="col"> {{-- input de proyecto --}}
              ...
              <div class="row">
                ...
                <div class="col">
                  <button type="button" title="Buscar por RUC en la base de datos de Sunat" class="btn btn-info " id="botonBuscarPorRUC"
                    onclick="consultarPorRuc()">
        ...
        <table id="detalles" class="table table-striped table-bordered table-condensed table-hover" style='background-color:#FFFFFF;'>
          <thead>
            <th class="text-center">
              <div>
                <input type="number" min="0" class="form-control" name="cantidadDetalle" id="cantidadDetalle" value="1"
            ...
            <th class="text-center">
              <div class="input-group" onclick="clickDiv(1)">
                ...
                <input type="number" min="0" class="form-control" aria-label="Text input with radio button"
                  name="valorVentaDetalle" id="valorVentaDetalle" value="0" onchange="cambioValorInput()">
              </div>
            </th>
            <th class="text-center">
              <div class="input-group" onclick="clickDiv(2)">
                ...
                <input type="number" min="0" class="form-control" aria-label="Text input with radio button"
                  name="precioVentaDetalle" id="precioVentaDetalle" value="0" readonly onchange="cambioValorInput()">
              </div>
            </th>
            <th class="text-center">
              <div>
  ...
  <script type="application/javascript">
    //se ejecuta cada vez que escogewmos un file
        ...
        $(document).ready(function(){
            ...
            contadorCaracteres('observacion','contadorObservacion',{{App\Utils\Configuracion::tamañoObservacionOC}});
