  ...
  <div id="principal" style="width: 635px; height: 750px">
    ...
    <table style="width:100%">
      <tbody style="width:100%">
        ...
        <tr>
          <td></td>
          <td colspan="4" style="text-align: center">Son : {{ $orden->escribirTotalSolicitado() }} {{ $orden->getMoneda()->nombre }}
          </td>
          <td style="text-align: right; font-weight: bold; background-color:rgb(238, 238, 238);">TOTAL {{ $orden->getMoneda()->simbolo }}
          </td>
