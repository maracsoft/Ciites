...
<div class="panel-group card">
  <div class="panel panel-default">
      <a id="giradorArchivos" onclick="girarIconoDescarga()" data-toggle="collapse" href="#collapseArchivos" style="" > 
      ...
      <div id="collapseArchivos" class="panel-collapse collapse card-body p-0">
        <table class="table table-striped table-bordered table-condensed table-hover" 
          ...
          <tbody>
            @foreach ($orden->getListaArchivos() as $itemArchivo)
            <tr>
                <td style = "padding: 0.50rem">
                    <a href="{{route('OrdenCompra.descargarArchivo',$itemArchivo->codArchivoOrden)}}">
                ...
                <td>
                    <a href="#" onclick="clickEliminarArchivo({{$itemArchivo->codArchivoOrden}},'{{$itemArchivo->nombreAparente}}')">
...
<script>
    ...
    function clickEliminarArchivo(codArchivoOrden,nombre){
      codArchivoAEliminar = codArchivoOrden;
    ...
    function ejecutarEliminacionArchivo(){
      location.href = "/OrdenCompra/eliminarArchivo/" + codArchivoAEliminar;
