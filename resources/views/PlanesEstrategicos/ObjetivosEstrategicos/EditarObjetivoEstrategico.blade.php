    ...
    function validarregistro() 
        {
            ...
            if (document.getElementById("descripcion").value == ""){
                alerta("Ingrese el descripcion del proyecto");
                $("#descripcion").focus();
            }

            else{
                document.frmObjetivoEstrategico.submit(); // enviamos el formulario	
            }
        }
    
</script>

<form id="frmObjetivoEstrategico" name="frmObjetivoEstrategico" role="form" 
    action="{{route('ObjetivoEstrategico.actualizar')}}" 
class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">

@csrf 


<div class="well"><H3 style="text-align: center;">Actualizar Objetivo estratégico</H3></div>
<br>
<div class="container">
    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="codObjetivoEstrategico" name="codObjetivoEstrategico"
                            value="{{$ObjetivoEstrategico->codObjetivoEstrategico}}"  placeholder="..." readonly>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="">
                            <input type="number" class="form-control" id="año" name="año" 
                                value="{{$ObjetivoEstrategico->año}}" placeholder="Ingrese año..." >
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        >{{$ObjetivoEstrategico->descripcion}}</textarea>
