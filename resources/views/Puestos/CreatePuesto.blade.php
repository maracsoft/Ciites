...
<script type="text/javascript"> 
    ...
    <br>
    <form id="frmPuesto" name="frmPuesto" role="form" action="{{route('GestionPuestos.store')}}" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
        @csrf 
