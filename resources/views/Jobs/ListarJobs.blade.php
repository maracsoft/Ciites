      ...
      <tbody>
        ...
        @foreach ($listaJobs as $job)
          <tr class="FilaPaddingReducido">
            ...
            <td>
              <button type="button" data-toggle="modal" data-target="#ModalJob" onclick="clickEditarJob({{ $job->getId() }})"
                class='btn  btn-info btn-sm' title="Editar JOB">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="frmJob" name="frmJob" action="{{ route('Jobs.GuardarEditar') }}" method="POST">
            <input type="{{ App\Utils\Configuracion::getInputTextOHidden() }}" name="codJob" id="codJob" value="-1">
            @csrf
