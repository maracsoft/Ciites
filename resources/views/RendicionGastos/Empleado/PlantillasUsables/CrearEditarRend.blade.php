...
*/
  ...
  <tr class="selected" id="fila` + item + `" name="fila` + item + `">
    ...
    <td style="text-align:center;">
      ...
      <input type="text" class="form-control" name="nroEnRendicion` + item + `" id="nroEnRendicion` + item + `" value="` + element
        .nroEnRendicion + `" readonly>
    </td>
    <td style="text-align:center;">
    ...
    <td style="text-align:right;">
      <input type="text" class="form-control text-right" value="` + number_format(element.importe, 2) + `" readonly>
        ...
        <td style="text-align:center;">
          <input type="text" class="form-control" name="colCodigoPresupuestal` + item + `" id="colCodigoPresupuestal` + item +
        `" value="` + element.codigoPresupuestal + `" readonly>
        </td>
        <td style="text-align:center;">
    ...
    if (saldoFavEmpl > 0) { //recibido < gastado -> el empleado debe recibir dinero de cedepas para reponer
      ...
      document.getElementById("labelAFavorDe").innerHTML = "Saldo a Favor de Ciites";
    }
