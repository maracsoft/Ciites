      ...
      <div class="row" id="divTotal" name="divTotal">
        ...
        <div class="col-12 col-md-6">
          <div class="row">
            ...
            <div class="w-100"></div>
            <div class="col">
              @if ($rendicion->verificarEstado('Creada') || $rendicion->verificarEstado('Aprobada') || $rendicion->verificarEstado('Subsanada'))
                <button type="button" class='btn btn-warning float-right' data-toggle="modal" data-target="#ModalObservar">
