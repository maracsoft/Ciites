      ...
      <table class="table table-hover"  style="font-size: 10pt; margin-top:10px; ">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th width="9%"  scope="col" style="text-align: center">F. Aprobación / Observación</th>
        ...
        <tbody>
          ...
          @foreach($listaRendiciones as $itemRendicion)
              <tr>
                ...
                <td style = "padding: 0.40rem; text-align: center">{{$itemRendicion->formatoFechaHoraRevisionGerente()}}</td>
