          ...
          <tbody>
              ...
              <tr>
                <td style = "padding: 0.50rem">
                  ...
                  <td>
                    <a href="#" onclick="clickEliminarArchivo({{$itemArchivo->codArchivoRend}},'{{$itemArchivo->nombreAparente}}')">
...
<script>
    ...
    function clickEliminarArchivo(codArchivoRend,nombre){
      codArchivoAEliminar = codArchivoRend;
    ...
    function ejecutarEliminacionArchivo(){
      location.href = "/RendicionGastos/eliminarArchivo/" + codArchivoAEliminar;
