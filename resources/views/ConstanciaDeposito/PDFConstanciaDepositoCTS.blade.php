  ...
  <div id="principal" style="">
    <table class="w-100">
      <thead>
        <tr>
          <th>
            <img class="imagen_logo" src="{{ App\Utils\Configuracion::getRutaImagenCedepasPNG() }}">
          </th>
      ...
      <tbody>
        <tr>
          <td colspan="2" class="texto_escrito">
            ...
            domiciliado en Nestor Batanero 137 Dpto. 101, distrito de Santiago de Surco, provincia y departamento de Lima, con RUC N°
            20610973001, representado por
