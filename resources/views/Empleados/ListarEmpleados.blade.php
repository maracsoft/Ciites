...
<div class="card-body">
      ...
      <tr style="background-color:{{$itemempleado->getColorSegunActivo()}}">
          ...
          <td>
            @if($itemempleado->esObservador())
              <a href="{{route('GestionUsuarios.verProyectosObservador',$itemempleado->codEmpleado)}}" class="btn btn-success btn-xs btn-icon icon-left" >
          ...
          <td>
              ...
              @if($itemempleado->estaActivo())
                ...
                <button type="button" onclick="clickCesarEmpleado({{$itemempleado->getId()}})" class="btn btn-danger btn-xs btn-icon icon-left" title="Le quita el acceso al sistema.">
  ...
  <script>
    ...
    function reactivarEmpleado(){
        location.href = "/GestiónUsuarios/"+codEmpleadoAReactivar+"/reactivar"
    }
    ...
    function cesarEmpleado(){
        location.href = "/GestiónUsuarios/"+codEmpleadoACesar+"/cesar"
    }
