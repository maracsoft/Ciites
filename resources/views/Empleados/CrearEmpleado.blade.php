...
@section('contenido')
  ...
  <br>
  <div class="container">
    <form id="frmempresa" name="frmempresa" role="form" action="{{ route('GestionUsuarios.store') }}"
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    function validarFormulario() {
      limpiarEstilos(
        ['usuario', 'contraseña', 'contraseña2', 'nombres', 'apellidos', 'DNI', 'correo', 'codigo', 'sexo', 'fechaNacimiento', 'cargo',
          'direccion', 'telefono'
        ]);
      msj = "";

      msj = validarTamañoMaximoYNulidad(msj, 'usuario', {{ App\Utils\Configuracion::tamañoMaximoUsuario }}, 'usuario');
      msj = validarTamañoMaximoYNulidad(msj, 'codigo', {{ App\Utils\Configuracion::tamañoMaximoCodigoCedepas }}, 'Código del Colaborador');
      msj = validarTamañoMaximoYNulidad(msj, 'contraseña', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'contraseña');
      msj = validarTamañoMaximoYNulidad(msj, 'contraseña2', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'Repetir contraseña');
      msj = validarTamañoMaximoYNulidad(msj, 'nombres', {{ App\Utils\Configuracion::tamañoMaximoNombres }}, 'nombres');
      msj = validarTamañoMaximoYNulidad(msj, 'correo', {{ App\Utils\Configuracion::tamañoMaximoCorreo }}, 'correo');
      msj = validarTamañoMaximoYNulidad(msj, 'apellidos', {{ App\Utils\Configuracion::tamañoMaximoApellidos }}, 'apellidos');
      msj = validarNulidad(msj, 'DNI', 'DNI');
      msj = validarNulidad(msj, 'fechaNacimiento', 'Fecha de Nacimiento');

      msj = validarTamañoMaximoYNulidad(msj, 'cargo', {{ App\Utils\Configuracion::tamañoMaximoNombreCargo }}, 'Nombre del Cargo');
      msj = validarTamañoMaximoYNulidad(msj, 'direccion', {{ App\Utils\Configuracion::tamañoMaximoDireccion }}, 'Direccion');
      msj = validarTamañoMaximoYNulidad(msj, 'telefono', {{ App\Utils\Configuracion::tamañoMaximoTelefono }}, 'Telefono');
