...
@section('contenido')
  ...
  <form id="frmUsuario" name="frmUsuario" role="form" action="{{ route('GestionUsuarios.updateUsuario') }}"
      ...
      <div class="row">
        ...
        <div class="col">
          <div class=" ">
            ...
            <div class="">
              <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Ingrese nueva usuario..."
          ...
          <a href="{{ route('GestionUsuarios.Listar') }}" class="btn btn-info float-left"><i class="fas fa-arrow-left"></i> Regresar al
            Menu</a>
        </div>
        <div class="col-2">
...
@section('script')
  <script>
    ...
    function validarCambioContraseña() { //Retorna TRUE si es que todo esta OK y se puede hacer el submit
      ...
      msj = validarTamañoMaximoYNulidad(msj, 'password1', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'Contraseña nueva');
      msj = validarTamañoMaximoYNulidad(msj, 'password2', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'Repita Contraseña nueva');
