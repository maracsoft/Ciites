...
<script>
  ...
  function actualizarEstado(codProyecto,nombreProyecto){
    ...
    $.get("/GestiónUsuarios/asignarProyectoAObservador/"+codEmpleado+"*"+codProyecto, function(data){
      if(data==1) /* Ya existia y lo destruimos */
        alertaMensaje('Enbuenahora','Se ELIMINÓ el observador {{$empleado->getNombreCompleto()}} del proyecto '+nombreProyecto+'.','success');
      
      if(data==2) /* no existia y lo creamos */
        alertaMensaje('Enbuenahora','Se AGREGÓ al observador {{$empleado->getNombreCompleto()}} al proyecto '+nombreProyecto+'.','success');
  ...
  function asignarTodosLosProyectos(){
    ...
    $.get("/GestiónUsuarios/asignarObservadorATodosProyectos/"+codEmpleado, function(data){
  ...
  function quitarTodosLosProyectos(){
    ...
    $.get("/GestiónUsuarios/quitarObservadorATodosProyectos/"+codEmpleado, function(data){
