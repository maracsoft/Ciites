...
@section('contenido')
  ...
  <div class="container">
    ...
    <form id="frmempresa" name="frmempresa" role="form" action="{{ route('GestionUsuarios.updateEmpleado') }}" class=""method="post"
      enctype="multipart/form-data">
      @csrf
      <input type="text" class="form-control" id="codEmpleado" name="codEmpleado" placeholder="Codigo" value="{{ $empleado->codEmpleado }}"
        hidden>
            ...
            <tbody>
              @foreach ($puestos as $puesto)
                <tr>
                  ...
                  <td class="">
                    <input class="grande" type="checkbox" id="CB_{{ $puesto->codPuesto }}"
                      onchange="actualizarEstado({{ $puesto->codPuesto }})" @if ($empleado->verificarPuesto($puesto->codPuesto)) checked @endif>
                  </td>
                </tr>
              @endforeach
            </tbody>
