...
@section('contenido')
  <br>
  <div class="well">
    <H3 style="text-align: center;">Cambiar mi contraseña</H3>
  </div>
  <br>
  ...
  <form id="frmUsuario" name="frmUsuario" role="form" action="{{ route('GestionUsuarios.updateContrasena') }}"
...
@section('script')
  <script>
    ...
    function validarCambioContraseña() { //Retorna TRUE si es que todo esta OK y se puede hacer el submit
      ...
      msj = validarTamañoMaximoYNulidad(msj, 'contraseñaActual1', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'Contraseña Actual');
      msj = validarTamañoMaximoYNulidad(msj, 'contraseñaActual2', {{ App\Utils\Configuracion::tamañoMaximoContra }},
      ...
      msj = validarTamañoMaximoYNulidad(msj, 'contraseña', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'Nueva Contraseña');
      msj = validarTamañoMaximoYNulidad(msj, 'contraseña2', {{ App\Utils\Configuracion::tamañoMaximoContra }}, 'Repetir Nueva Contraseña');
