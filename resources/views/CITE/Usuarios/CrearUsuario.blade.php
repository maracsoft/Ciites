...
<form method = "POST" action = "{{route('CITE.Usuarios.Guardar')}}" id="frmUsuarioCite" name="frmUsuarioCite"  enctype="multipart/form-data">
...
<script type="application/javascript">
        ...
        function registrar(){
            ...
            confirmarConMensaje('Confirmación','¿Desea crear el usuario?','warning',function(){            
