            ...
            <div class="row">
              ...
              <div class="col">
                <input type="text" readonly class="form-control"
                  value="{{ App\RequerimientoBS::calcularCodigoCedepas($objNumeracion) }}
                            ">
              </div>
              <div class="w-100"></div>
              <div class="colLabel">
              ...
              <div class="col">
                <input type="text" class="form-control" name="cuentaBancariaProveedor" id="cuentaBancariaProveedor" value=""
                  placeholder="En caso de no ser BBVA, colocar CCI">
              </div>
              <div class="w-100"></div>
          ...
          <div class="">
            <div style="row">
              <div class="col">
                ...
                <textarea class="form-control" name="justificacion" id="justificacion" aria-label="With textarea"cols="3"></textarea>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <input class="form-control" type="text" value="" id="codigoContrapartida" name="codigoContrapartida">
              </div>
            </div>
  ...
  <script type="application/javascript">
    //se ejecuta cada vez que escogewmos un file
        ...
        function validarFormularioCrear(){
            ...
            limpiarEstilos(['codProyecto','justificacion','cuentaBancariaProveedor','codigoPresupuestal','codigoContrapartida']);
