        ...
        <div class="col-12 col-md-4">
          @if($requerimiento->adminPuedeSubirArchivos())
            <div class="BordeCircular p-2 m-2" id="divEnteroArchivo">    
              <form method="POST" action="{{route('RequerimientoBS.Administrador.subirArchivosAdministrador')}}" id="frmSubirArchivosAdmin" name="frmSubirArchivosAdmin"  enctype="multipart/form-data">
                @csrf
