    ...
    <div class="row" id="" name="">                       
        ...
        @if($requerimiento->verificarEstado('Atendida') ) {{-- Si está lista para contabilizar --}}
            ...
            <div class="col-12 col-md-4">
              ...
              <form method="POST" action = "{{route('RequerimientoBS.Contador.Contabilizar')}}" id="frmContabilizarRequerimientoBS" name="frmContabilizarRequerimientoBS" enctype="multipart/form-data">
                  @csrf
