...
@section('titulo')
    Crear Tipo de Persona Juridica
@endsection
@section('contenido')
...
<script type="text/javascript"> 
    ...
    <br>
    <form id="frmPuesto" name="frmPuesto" role="form" action="{{route('GestiónTipoPersonaJuridica.store')}}" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
        @csrf 
            ...
            <div class="form-group row" style="margin-left:250px;">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" rows="3" name="siglas" id="siglas" placeholder="Siglas ..." style="margin-top: 0px; margin-bottom: 0px; height: 61px;"></textarea>
                </div>
            </div>
