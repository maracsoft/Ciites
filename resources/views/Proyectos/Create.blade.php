      ...
      <div class="col" style="">
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <input type="text" class="form-control" id="codigoPresupuestal" name="codigoPresupuestal" value="" placeholder="...">
          </div>
          ...
          <div class="col">
            ...
            <select class="form-control" name="codPEI" id="codPEI">
              ...
              @foreach ($listaPEIs as $itemPEI)
                <option value="{{ $itemPEI->codPEI }}">{{ $itemPEI->getPeriodo() }}</option>
              @endforeach
            </select>
          ...
          <div class="col">
            ...
            <select class="form-control" name="codGerente" id="codGerente">
              ...
              @foreach ($listaGerentes as $itemGerente)
                <option value="{{ $itemGerente->codEmpleado }}">{{ $itemGerente->getNombreCompleto() }}</option>
              @endforeach
            </select>
            ...
            <div class="">
              <select class="form-control" name="codEntidadFinanciera" id="codEntidadFinanciera">
                ...
                @foreach ($listaFinancieras as $itemFinanciera)
                  <option value="{{ $itemFinanciera->codEntidadFinanciera }}">{{ $itemFinanciera->nombre }}</option>
                @endforeach
              </select>
          ...
          <div class="col">
            ...
            <div class="input-group date form_date " data-date-format="dd/mm/yyyy" data-provide="datepicker" style=" ">
              <input type="text" class="form-control" name="fechaInicio" id="fechaInicio" value="" style="text-align:center;">
          ...
          <div class="col">
            ...
            <div class="input-group date form_date " data-date-format="dd/mm/yyyy" data-provide="datepicker" style=" ">
              <input type="text" class="form-control" name="fechaFinalizacion" id="fechaFinalizacion" value=""
          ...
          <div class="col">
            ...
            <select class="form-control" id="codTipoFinanciamiento" name="codTipoFinanciamiento">
              ...
              @foreach ($listaTipoFinanciamiento as $itemTipoFinanciamiento)
                <option value="{{ $itemTipoFinanciamiento->codTipoFinanciamiento }}">{{ $itemTipoFinanciamiento->nombre }}
                </option>
              @endforeach
            </select>
          </div>
          ...
          <div class="col">
            ...
            <select class="form-control" id="codMoneda" name="codMoneda">
              ...
              @foreach ($listaMonedas as $itemMoneda)
                <option value="{{ $itemMoneda->codMoneda }}">{{ $itemMoneda->nombre }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col">
            ...
            <div class="">
              <textarea class="form-control" name="nombreLargo" id="nombreLargo" cols="30" rows="2"></textarea>
            </div>
          </div>
          ...
          <div class="col">
            ...
            <div class="">
              <textarea class="form-control" name="objetivoGeneral" id="objetivoGeneral" cols="30" rows="2"></textarea>
            </div>
          </div>
          ...
          <div class="col cuadroCircularPlomo2">
            ...
            <input class="form-control" type="number" min="0" name="importeContrapartidaPoblacionBeneficiaria"
              id="importeContrapartidaPoblacionBeneficiaria" value="0" onchange="actualizarPresupuestoTotal()">
...
@section('script')
  ...
  <script>
    ...
    function validarActualizacion() {
      msjError = "";
      limpiarEstilos(['fechaInicio', 'fechaFinalizacion', 'nombre', 'codigoPresupuestal', 'nombreLargo', 'objetivoGeneral', 'codSede',
      ...
      msjError = validarTamañoMaximoYNulidad(msjError, 'codigoPresupuestal', {{ App\Configuracion::tamañoMaximoCodigoPresupuestalP }},
        'Codigo Presupuestal');
      msjError = validarTamañoMaximoYNulidad(msjError, 'nombreLargo', {{ App\Configuracion::tamañoMaximoNombreLargoP }}, 'Nombre Largo');
      msjError = validarTamañoMaximoYNulidad(msjError, 'objetivoGeneral', {{ App\Configuracion::tamañoMaximoObjetivoGeneralP }},
        'Objetivo General');
      ...
      msjError = validarNoNegatividadYNulidad(msjError, 'importeContrapartidaPoblacionBeneficiaria',
        'Importe de contrapartida de la Poblacion Beneficiaria');
