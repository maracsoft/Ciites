    ...
    <div class="card">
      ...
      <div class="card-body p-2">
        <div class=" d-flex flex-wrap">
          ...
          <div title="Si no se selecciona ningún proyecto, se mostrará información de todos los proyectos sobre los que tenga autorización (gerente y supervisor)">
            <b for="">
              Filtros:
            </b>
...
<script>
    ...
    function loadDashboardData(){
      ...
      url = "/GestiónProyectos/getDashboardInfo?codsProyectos="+InputCodsProyectos.value;;
      formData = {
