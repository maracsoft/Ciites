...
@section('contenido')
  ...
  <form method = "POST" action = "{{ route('SolicitudFondos.Gerente.Aprobar') }}" id="frmSoli">
    {{-- CODIGO DEL EMPLEADO --}}
    ...
    <div class="row" id="divTotal" name="divTotal">
      ...
      <div class="col-md-2">
        ...
        <input type="text" class="form-control text-right" name="total" id="total"
          value="{{ number_format($solicitud->totalSolicitado, 2) }}" readonly>
      </div>
    </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                @if ($solicitud->verificarEstado('Creada') || $solicitud->verificarEstado('Subsanada'))
                  <div class="row">
                    <div class="col">
                      <button type="button" id="botonAprobar" onclick="aprobar()" class='btn btn-success float-right'
                        style="margin-left: 6px">
                        <i class="fas fa-check"></i>
                        Aprobar
                      </button>
                      <button type="button" class='btn btn-warning float-right' style="margin-left: 6px" data-toggle="modal"
                        data-target="#ModalObservar">
                        <i class="fas fa-eye-slash"></i>
                        Observar
                      </button>
                      <a href="#" onclick="clickRechazar()" class='btn btn-danger float-right'>
...
@section('script')
  <script>
    ...
    function validarEdicion() {
      ...
      } else if (textJustificacion.value.length > {{ App\Utils\Configuracion::tamañoMaximoJustificacion }}) {
        cambiarEstilo('justificacion', 'form-control-undefined');
        msj = 'La longitud de la justificación tiene que ser maximo de {{ App\Utils\Configuracion::tamañoMaximoJustificacion }} caracteres.';
