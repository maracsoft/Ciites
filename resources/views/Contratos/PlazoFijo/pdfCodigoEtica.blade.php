...
<p style="text-align: justify">
    ...
    <br>“Afirmados en el propósito de Dios y la búsqueda del desarrollo humano, nos proponemos la siguiente misión:
    <br>Fortalecer las capacidades de varones y mujeres: líderes de la sociedad civil, pequeños y medianos productores emprendedores, funcionarios y autoridades de gobiernos regionales y locales, para contribuir a: 
    <br>-	La consolidación de la gobernabilidad local, la institucionalidad democrática y el capital social.
    <br>-	La gestión sostenible de los recursos naturales y el ambiente, con énfasis en el agua.
    <br>-	El desarrollo de iniciativas sostenibles y rentables de sectores económicos que dinamicen la macroregión norte del Perú. 
    <br>
</p>
...
<p style="text-align: justify">
    <b>
        3.	LOS PRINCIPIOS INSTITUCIONALES
    </b>
    <br>-	El ecumenismo y la interculturalidad
    <br>-	La equidad 
    <br>-	La solidaridad
    <br>-	La honestidad
    <br>-	La responsabilidad y consecuencia
</p>
...
<p style="text-align: justify">
    ...
    <b>
        El respeto a las obligaciones contractuales y legales:
    </b>
    {{$contrato->getTrabajadore()}}  se compromete a respetar las leyes vigentes en el país en el cual prestan sus servicios y garantizan que el personal de la Institución y consultores cumplan con sus compromisos contractuales.
    <br>
    <b>
        Igualdad de derechos: 
    </b>
    En las relaciones interpersonales no deberá existir discriminación  con respecto a género, color, religión, cultura, educación, nivel social, discapacidad, edad, orientación sexual, estado civil o nacionalidad, o de cualquier otra índole.
    <br>
    <b>
        Transparencia:
    </b>
     {{$contrato->getTrabajadore()}}  asegura que todas sus acciones y razones para ejecutarlas sean transparentes, sustentadas, comprensibles y motivadas.
    <br>
    <b>
        Lealtad:
    </b>
    ...
    <b>
     ...
     {{$contrato->getTrabajadore()}}  se relacionará con las contrapartes y los grupos meta de manera siempre justa, digna de crédito y basada en la confianza, honestidad y respeto. 
    <br>
    <b>
...
<p style="text-align: justify">
    ...
    <br>Las reglas que rigen los aspectos administrativos, financieros y técnicos de la Institución se encuentran contenidos en el Reglamento Interno. {{$contrato->getTrabajadore()}}  se compromete a cumplir y hacer cumplir dicho Reglamento. En particular se compromete a: 
    ...
    <br><br>
    <b>
        A.	CONTRATACIÓN DE PERSONAL Y CONFLICTO DE INTERESES 
    </b>
    ...
    <div style="margin-left: {{$margen}}; text-align:justify" >
        ...
        <br>-	No se hará uso de los recursos institucionales para fines particulares, bajo ningún concepto. Esto aplica también respecto al uso de las instalaciones u otros recursos, como al personal de la institución para fines particulares, salvo expresa autorización de la Dirección Gerencia o Direcciones Ejecutivas de Filial. 
    ...
    <b>
        C.	TEMAS INFORMATICOS 
    </b>
    <div style="margin-left: {{$margen}}; text-align:justify" >
         
         -	Los programas de computadoras están protegidos por derechos de autor. La Política Institucional es de respeto a estos derechos y ceñirnos al cumplimiento de la ley. Está prohibido realizar copias si autorización salvo que la licencia del programa lo permita. Los especialistas en sistemas de computadora no pueden copiar líneas de código escritas por terceros sin el permiso de los mismos.
        <br>-	El uso del internet y correo electrónico es exclusivo para la actividad laboral. Está prohibido bajar información que no sea de dominio público. Tampoco se puede abusar del acceso a internet para fines personales. 
        <br>-	El sistema de correo electrónico genera un registro permanente y es susceptible de ser interceptado, por tanto se debe utilizar con cautela y responsabilidad; utilizado de manera adecuada y con profesionalismo, evitando estilos irrespetuosos, injuriosos, obscenos. Este sistema es recurso de la empresa, por lo cual en circunstancias especiales puede decidir analizarlo, reservando el derecho de acceder a las comunicaciones realizadas por el correo electrónico institucional.
        <br>
    ...
    <div style="margin-left: {{$margen}}; text-align:justify" >
        -	Todos somos responsables de generar un ambiente de trabajo agradable, motivado por el diálogo y el respeto mutuo. Se espera que los colaboradores compartan sus conocimientos y estimulen el perfeccionamiento profesional de sus colegas, buscando la excelencia de manera colectiva. 
        <br>-	Las relaciones interpersonales deben establecerse sobre la confianza y el trato justo, cada persona es responsable por sus acciones y debe considerar las consecuencias que estas generan sobre las demás. 
        <br>-	Está fuera de lugar el uso de formas de hostilidad, coacción, asedio moral, o uso del poder para obtener ventajas o imponer autoridad, pues afectan la cohesión organizacional y la autoestima personal,  
        <br>-	{{$contrato->getTrabajadore()}}  debe contribuir a fomentar un ambiente de trabajo positivo, motivador, de equidad y promover el trabajo en equipo, para así evitar la desmotivación, la discriminación y el fraude
        <br>-	No a la discriminación: Todo acto o declaración que pone en desventaja a los individuos de origen, nacionalidad, color, género, religión diferentes u otros criterios pertinentes tales como la apariencia, discapacidad, edad, orientación sexual, etc. o que los humilla o ridiculiza se considera como acto de discriminación y por consiguiente {{$contrato->getTrabajadore()}}  se compromete a no tolerarlos ni hacia el interior de la Institución, ni hacia terceros que tengan vinculación.
        <br>-	No al acoso/La intimidación: {{$contrato->getTrabajadore()}}  entiende y rechaza el acoso/la intimidación entendida como la exclusión y humillación sistemática de alguien por una o mas personas. Es decir una conducta hostil que sucede repetidamente y durante un periodo de tiempo significativo. Los casos típicos de acoso son actos que atentan contra la reputación o relaciones sociales de una persona, obstaculizan la posibilidad de comunicación, menosprecian la calidad de trabajo o hasta dañan la salud.  
        <br>-	No se considera como acoso una discusión acalorada o llamada de atención, que pudiera pasar en cualquier circunstancia de trabajo, con tal de que el incidente o intercambio de pareceres se maneje de forma abierta y que  pueda servir para cambios positivos.
        <br>-	No al acoso sexual: {{$contrato->getTrabajadore()}}  entiende que hay una línea muy fina pero clara entre ser amigable, servicial y el acoso sexual: cualquier clase amigable de contacto estrecho con alguien se basa en el acuerdo mutuo entre dos personas. Sin embargo, el acoso sexual ocurre cuando una persona intencionalmente no mantiene la distancia en circunstancias inoportunas en las que no ha sido invitado a ello. Los individuos experimentan ‘el no mantener la distancia’ de maneras diferentes, por lo tanto, no hay un límite general de aceptación. Dicha conducta implica la degradación de una persona en base a su sexo y es ofensivo, humillante, y en muchos casos hasta implica una amenaza a las víctimas. Así que, {{$contrato->getTrabajadore()}}  declara no tolerarlo ni aceptarlo. 
        <br>-	Queja falsa: {{$contrato->getTrabajadore()}}  reconoce que la acusación falsa y la información engañosa deberán ser sujeto de una acción disciplinaria en el grado apropiado.
        <br>
    ...
    <b>
        E.	CORRUPCIÓN Y SOBORNOS
    </b>
    <div style="margin-left: {{$margen}}; text-align:justify" >

      
            -	No admitimos conductas reñidas con la ética y la moral institucional, {{$contrato->getTrabajadore()}}  considera que la aceptación así como la entrega de regalos u otras ventajas (dinero, préstamos, premios, precios o pasajes reducidos, etc.) de/a provenientes de fuentes ilegales, producto de corrupción, narcotráfico. 
        <br>-	En el caso de aceptar un regalo, tal regalo se debe utilizar para propósitos organizacionales o humanitarios o conjuntamente con otro personal. Asimismo, {{$contrato->getTrabajadore()}}  reconoce que se debe documentar el procedimiento. Si hay que rehusar un regalo o una ventaja, se deberá informar a la persona que ofrece tal regalo o ventaja sobre las normas y las prácticas institucionales.
        <br>-	En el ejercicio de la transparencia y de una ciudadanía responsable, condenamos cualquier forma de soborno de autoridades o de funcionarios públicos, mediante ventajas personales, afectando el cumplimiento de sus obligaciones u otros procedimientos que constituyen infracción penal.
        <br>
    </div>
...
<table id="TablaFirmaCodigoEtica" style="width: 100%; text-align:center; margin-top:90pt">
    <tbody>
        <tr>
            <td>
                <b>
