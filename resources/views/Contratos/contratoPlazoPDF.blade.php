  ...
  <body @if ($contrato->estaAnulado()) class="anulado" @endif>
    ...
    <div class="contenidoContrato" style="">
      ...
      <p style="text-align: justify;">
        ...
        <b>{{ $contrato->direccion }}</b> provincia de <b>{{ $contrato->provinciaYDepartamento }}</b>, a quien en
      ...
      <p style="text-align: justify;">
        ...
        @else
          ...
          gubernamentales, con presencia en 16 regiones del país que contribuye con la formulación de propuestas de
          política
          para una reforma inclusiva del Estado y una adecuada gestión de los recursos públicos. Además, promueve y
          apoya el
          fortalecimiento de diversos mecanismos de asociación nacional e interregional entre actores de la sociedad
          civil,
          las sub instancias del Estado y de las organizaciones que forman parte de él. GPC reconoce la importancia del
          desarrollo
          y la democracia desde los territorios, ya que solo así será posible retomar el impulso del proceso de
          descentralización.
          Por ello, viene construyendo una visión propia de la Gobernanza Territorial, partiendo de identificar y
          respetar las
          diversidades y particularidades de los actores múltiples en los territorios para la promoción del desarrollo
          democrático como componente
          ...
          <i>
            ...
            de Fondos generado por GPC, asumiendo CEDEPAS Norte la representación legal, laboral y tributaria para la
            ejecución
            de sus proyectos. En virtud del mismo, el personal para dicha ejecución, viene siendo contratado
            directamente por CEDEPAS Norte, con
            dedicación exclusiva a los proyectos de GPC, no constituyendo personal del staff de CEDEPAS Norte, sino de
            la
      ...
      <p style="text-align: justify;">
        ...
        dentro del proyecto.
        <b>
          {{ $contrato->getTrabajadore() }}</b> se obliga a cumplir con las actividades descritas en los Términos de
        Referencia que dieron origen a su
      ...
      <p style="text-align: justify;">
        ...
        <b>
          EL EMPLEADOR.
        </b>El Contrato se celebra al amparo de artículo 63º del Decreto Supremo 003-97–TR- Ley de Productividad y
        Competitividad Laboral, bajo la
        ...
        <b>
          {{ $contrato->getTrabajadore() }}</b>, para encargarse de las labores descritas en razón de las causas
        objetivas que en ella se precisan.
      </p>
      ...
      <p style="text-align: justify;">
        ...
        desempeñará sus labores parcialmente fuera del centro de trabajo, no encontrándose sujeto a fiscalización
        inmediata, ni
      ...
      <p style="text-align: justify;">
        ...
        y
        <b>EL EMPLEADOR</b>, pactan las siguientes condiciones especiales, que regularán la ejecución del presente
        contrato:
        <br>
        ...
        </b>se compromete a guardar confidencialidad y reserva de la información a la que acceda en virtud del presente
        contrato.
        <br>
      ...
      <p style="text-align: justify;">
        ...
        <br>
        Se firma en la ciudad de <b>{{ $contrato->getSede()->nombre }}</b> el
