...
class Builder
{
    ...
    public function isThisAColumn($column_name){
      ...
      //Debug::mensaje("Verificando si $column_name está dentro de ".$this->getTableName());
      if(in_array($column_name,$columnas_existentes,true)){
        //error_log("SÍ ESTÁ");
        return true;
      }

      Debug::mensajeError('Builder.php ',"$column_name no está dentro de ".$this->getTableName());
      return false;
