...
class RendicionGastosController extends Controller
{
  ...
  public function listarRendicionesParaObservador(Request $request)
  {
    ...
    return view('RendicionGastos.Observador.ListarRendiciones', compact(
      'filtros_usados_paginacion',
      'filtros_usados',
  ...
  public function listarEmpleado(Request $request)
  {
    ...
    return view(
      'RendicionGastos.Empleado.ListarRendiciones',
  ...
  { //le pasamos la id de la rendicion de gastos
    $rendicion = RendicionGastos::findOrFail($id);
  ...
  function API_listarRENDeEmpleado($codEmpleado)
  {
    ...
    $listaRendiciones = RendicionGastos::where('codEmpleadoSolicitante', '=', $codEmpleado)
