...
class OperacionesController extends Controller
{
  ...
  public function ListarOperaciones(Request $request)
  {
    ...
    return view('Operaciones.ListarOperaciones', compact(
      'listaOperaciones',
      'listaEmpleados',
      'buscar_codigoCedepas',
      'buscar_tipoDocumento',
      'buscar_codEmpleado'
    ));
  }
  ...
  function GetListadoBusqueda(Request $request)
  {
    ...
    return view('Operaciones.Invocables.inv_listadoBuscadorMaestro', compact(
      'listaSOF',
      'listaREN',
      'listaREP',
      'listaREQ',
