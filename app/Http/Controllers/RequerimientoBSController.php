...
class RequerimientoBSController extends Controller
{
    ...
    public function listarParaObservador(Request $request){
      ...
      return view('RequerimientoBS.Observador.ListarRequerimientos',compact('filtros_usados_paginacion','filtros_usados','proyectosDelObservador','estadosRequerimiento',
          'listaRequerimientos','listaBancos','empleado','empleados','estadosRequerimiento'));
    ...
    public function rechazarComoGerente($id){//gerente-administrador (codRequerimiento)
      try{
        DB::beginTransaction();
        $requerimiento=RequerimientoBS::findOrFail($id);
    ...
    public function observarComoGerente(Request $request){//gerente-administracion
        try{
          DB::beginTransaction();
