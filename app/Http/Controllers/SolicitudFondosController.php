...

{
    ...
    public function listarSolicitudesParaGerente(Request $request){
        ...
        return view('SolicitudFondos.Gerente.ListarSolicitudes',compact('filtros_usados_paginacion','filtros_usados',
            'listaSolicitudesFondos','listaBancos','empleado','proyectosDelGerente','empleados'));
    }
    ...
    */
    public function listarSolicitudesParaJefe(Request $request){
        ...
        return view('SolicitudFondos.Administracion.ListarSolicitudes',
    ...
    public function listarSolicitudesParaObservador(Request $request){
      ...
      return view('SolicitudFondos.Observador.ListarSolicitudes',compact('filtros_usados_paginacion','filtros_usados','proyectosDelObservador','estadosSolicitud',
          'listaSolicitudesFondos','listaBancos','empleado','empleados'));
  }
