...
class ParametroSistema extends Model
{
    ...
    const Parametros = [
      ...
      "creacionREP_max",
      "activarAyuda",
      "busquedaREP_cantDatos",
      "busquedaREP_fechaInicial",
      "busquedaREP_cantDiasMaximo",
      "busquedaREP_horaMinima",
      "busquedaREP_horaMaxima",
      "busquedaREP_min_segundos",
      "busquedaREP_max_segundos",
      "listaArticuladores",
      "listaEquipos",
      "activarReportesAExcel",
      "listaIdsUsuariosRepetidos",
      ...
      "listaRelacionesAsistenciaRepetidas",
      "listaRelacionesUsuarioUnidadRepetidas",
      "cite-servicio-link-drive",
      "ppm_actividad_link_drive",
      "telegram_errorchannel_id",
      "env",
      "cronjob_limite_usuarios_corrida",
      "proyect_folder_path",
      "carpeta_tests_zip",
      "ruta_migraciones"
    ];
