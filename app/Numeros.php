...
class Numeros
{
  ...
  static function convertir($n)
  {
    ...
    switch (true) {
      case ($n >= 1 && $n <= 29):
        $sinMayusculas = Numeros::basico($n);
        break;
      case ($n >= 30 && $n < 100):
        $sinMayusculas = Numeros::decenas($n);
        break;
      case ($n >= 100 && $n < 1000):
        $sinMayusculas = Numeros::centenas($n);
        break;
      case ($n >= 1000 && $n <= 999999):
        $sinMayusculas = Numeros::miles($n);
        break;
      case ($n >= 1000000):
        $sinMayusculas = Numeros::millones($n);
        break;
    }
