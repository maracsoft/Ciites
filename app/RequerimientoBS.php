...
class RequerimientoBS extends DocumentoAdministrativo
{
  ...
  protected $fillable = [
    ...
    'cantArchivosEmp',
    'terminacionesArchivosEmp',
    'cantArchivosAdmin',
    'terminacionesArchivosAdmin',
    'codProyecto',
    'observacion'
  ];
  ...
  public function borrarArchivosEmp()
  ...
  public function borrarArchivosAdmin()
  { //borra todos los archivos que sean de esa rendicion
  ...
  //O SI ACTIVÉ EL PARAMETRO EN SISTEMA ESPECIAL PA ESO XD Son dos parámetros, un booleano y un numerico que es el id
  ...
  public function buildPDF(): Dompdf
  {
    ...
    $html_view = view('RequerimientoBS.PdfRBS', compact('requerimiento', 'listaItems'))->render();
  ...
  */
  ...
  public function borrarArchivosAdm()
  { //borra todos los archivos que sean de esa rendicion
  ...
  {
    $tipo_documento = TipoDocumento::where('abreviacion', 'REQ')->first();
